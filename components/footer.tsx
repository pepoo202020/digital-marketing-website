...
export const Footer = () => {
  ...
  return (
    <footer className="w-full">
      <div className="flex flex-col justify-start w-full items-start bg-[#191a23] px-4 sm:px-8 md:px-[60px] pt-8 md:pt-[55px] pb-8 md:pb-[50px] rounded-tl-[25px] rounded-tr-[25px] md:rounded-tl-[45px] md:rounded-tr-[45px] ">
        <div className="flex flex-col justify-start items-start w-full gap-8 md:gap-[50px] ">
          <div className="flex flex-col justify-start items-start w-full gap-8 md:gap-[66px]">
            {/* Top section with logo and navigation */}
            <div className="flex flex-col md:flex-row justify-between items-center w-full gap-6 md:gap-0">
              {/* Logo */}
              <Link href="/" aria-label="Positivus Home">
                <svg
                  width={180}
                  height={30}
                  viewBox="0 0 180 30"
                  ...
                  className="w-[150px] h-auto md:w-[180px] md:h-[29px]"
              ...
              <nav className="hidden md:flex justify-start items-center gap-6 lg:gap-10">
                <Link
                  href="/about"
                  className="text-base md:text-lg text-white hover:text-[#b9ff66] transition-colors"
                >
                  About us
                </Link>
                <Link
              ...
              {/* Social Media Icons */}
              <div className="flex justify-center md:justify-start items-center gap-4 md:gap-5 mt-4 md:mt-0">
            ...
            {/* Mobile Navigation */}
            <nav className="flex md:hidden justify-between items-center flex-wrap gap-4">
              <Link
                href="/about"
                className="text-base text-white hover:text-[#b9ff66] transition-colors"
              >
                About us
              </Link>
              <Link
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start w-full gap-8 lg:gap-4 mb-2">
              {/* Contact Information */}
              <div className="flex flex-col justify-start items-start gap-6 md:gap-[27px]">
                <div className="flex flex-col justify-start items-start">
                  <div className="flex flex-col justify-start items-start px-[7px] rounded-[7px] bg-[#b9ff66]">
                ...
                <div className="flex flex-col justify-start items-start gap-4 md:gap-5">
                  ...
                  <address className="text-base md:text-lg text-white not-italic">
              ...
              <div className="w-full lg:w-auto flex flex-col sm:flex-row justify-start items-center gap-4 p-6 md:p-10 rounded-[14px] bg-[#292a32]">
                <form
                  onSubmit={handleSubscribe}
                  className="w-full sm:w-auto flex flex-col sm:flex-row gap-4 items-center"
                >
                  <input
                    type="email"
                    placeholder="Email"
                    ...
                    className="w-full sm:w-[285px] px-4 md:px-[35px] py-4 md:py-[22px] rounded-[14px] border border-white bg-transparent text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-[#b9ff66]"
                  />
                  <button
                    type="submit"
                    className="w-full sm:w-auto px-6 md:px-[35px] py-4 md:py-5 rounded-[14px] bg-[#b9ff66] text-lg md:text-xl text-black hover:bg-[#a8e85c] transition-colors"
                  >
                    Subscribe to news
                  </button>
                </form>
        ...
        {/* Footer Bottom */}
        <div className="flex flex-col justify-start items-start w-full gap-6 md:gap-[50px]">
          <div className="w-full h-px bg-white"></div>
          <div className="flex flex-col sm:flex-row justify-between w-full items-center sm:items-start gap-4 sm:gap-10">
            <p className="text-sm md:text-lg text-center sm:text-left text-white">
              © 2023 Positivus. All Rights Reserved.
            </p>
            <Link
              href="/privacy"
              className="text-sm md:text-lg text-center sm:text-left text-white hover:text-[#b9ff66] transition-colors"
            >
              Privacy Policy
            </Link>
          </div>
